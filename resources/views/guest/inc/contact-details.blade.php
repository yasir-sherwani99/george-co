<div class="contact-details d-flex justify-content-between flex-column">
    <div class="header-contact">
        <h4 class="font-34 font-weight-bold text-white">Contact Information</h4>
        <p class="font-18 font-weight-light text-white">
